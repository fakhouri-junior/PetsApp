...
public class PetProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        // set up notification on the cursor to be notified when changes occur
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        */
        ...
        if(gender > 2 || gender < 0){
            throw new IllegalArgumentException("Pet requires a valid gender, 0,1,2");
        }
        ...
        // notify cursors of changes using the content resolver
    ...
    private int updatePet(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        */
        ...
        int howManyRowsAffected = sqLiteDatabase.update(PetEntry.TABLE_NAME, values, selection, selectionArgs);
